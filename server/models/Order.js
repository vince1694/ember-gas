...
const orderSchema = mongoose.Schema(
    {
        ...
        orderType: { type: String, enum: ['REFILL', 'STORE_ACCESSORY'], default: 'REFILL' },
        serviceType: { type: String, default: 'refill' },
        assignedTo: { type: String, enum: ['vendor', 'admin'], default: 'vendor' },
